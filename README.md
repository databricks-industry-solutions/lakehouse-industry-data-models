...
Forty production-ready industry data models, each shipped in two flavours (ECM + MVM) — auto-generated by an AI agent that turns a "user vibes" into a Unity-Catalog-ready model with schemas, foreign keys, sample data, metric views, ontology tags, and DBML diagrams.
